...
const [mobileSidebarVisible, setMobileSidebarVisible] = useState(false); // for sm
...
/>
       ...
       {/* SVG Toggle (shown on md and up) */}
<a
  href="#"
  className="layout-menu-toggle menu-link text-large ms-auto d-none d-md-block"
  onClick={(e) => {
    e.preventDefault();
    setSidebarCollapsed(!sidebarCollapsed);
  }}
>
  {/* your double-arrow SVG here */}
...
{/* Hamburger Toggle (shown on sm only) */}
<a
  href="#"
  className="layout-menu-toggle menu-link text-large ms-auto d-block d-md-none"
  onClick={(e) => {
    e.preventDefault();
