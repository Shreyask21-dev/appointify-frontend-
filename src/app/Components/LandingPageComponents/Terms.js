...
const Terms = () => {
  return (
    <section id="terms" className="container my-5">
      ...
      <p><strong>Last updated on Jul 14, 2025</strong></p>

     <p>
  For the purpose of these Terms and Conditions, the terms <strong>we</strong>, <strong>us</strong>, <strong>our</strong> refer to
  <strong> AURA ENTERPRISES</strong>, whose registered/operational office is Flat No. 202, Chintamani Building, Prasoon Dham Society,
  Near Aditya Birla Hospital, Chinchwad, Pune, Maharashtra 411033. The terms <strong>you</strong>, <strong>your</strong>,
  <strong>user</strong>, <strong>visitor</strong> refer to any natural or legal person who is visiting our website and/or has agreed to purchase from us.
</p>
...
<ul className="ps-3">
  ...
  <li>
    ...
    for which we shall not be liable. It shall be your own responsibility to ensure that any products, services, or
  ...
  <li>You may not create a link to our website from another website or document without AURA ENTERPRISES’s prior written consent.</li>
