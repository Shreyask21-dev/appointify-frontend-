      ...
      <div className="container pb-1 pb-lg-7">
        <div className="row content-space-t-2">
          ...
          <div className="col-sm mb-7 mb-sm-0">
            <h5 className="mb-3 link-light">Company</h5>
          ...
          <div className="col-sm mb-7 mb-sm-0">
            <h5 className="mb-3 link-light">Features</h5>
          ...
          <div className="col-sm mb-7 mb-sm-0">
            <h5 className="mb-3 link-light">Documentation</h5>
          ...
          <div className="col-sm">
            <h5 className="mb-3 link-light">Resources</h5>
        ...
        <div className="row mb-7">
          <div className="col-sm mb-3 mb-sm-0">
            ...
            <ul className="list-inline list-separator mb-0">
              <li className="list-inline-item link-light">
                <a className="text-light" href="#">Privacy &amp; Policy</a>
              </li>
              <li className="list-inline-item">
                <a className="text-light" href="#">Terms</a>
              </li>
              <li className="list-inline-item">
                <a className="text-light" href="#">Site Map</a>
              </li>
            </ul>
            {/* End Socials */}
          </div>
                ...
                <div className="btn-group">
                  ...
                  >
                    <span className="d-flex align-items-center">
                      <img
                        ...
                        src="dist/assets/vendor/flag-icon-css/flags/1x1/us.svg"
                        alt="Image description"
                        width="16"
                      />
                  ...
                  <div className="dropdown-menu" aria-labelledby="footerSelectLanguage">
                    ...
                    <a className="dropdown-item d-flex align-items-center" href="#">
                      <img
                        className="avatar avatar-xss avatar-circle me-2"
                        src="dist/assets/vendor/flag-icon-css/flags/1x1/de.svg"
                        alt="Image description"
                        width="16"
                      />
                      <span>Deutsch</span>
                    ...
                    <a className="dropdown-item d-flex align-items-center" href="#">
                      <img
                        className="avatar avatar-xss avatar-circle me-2"
                        src="dist/assets/vendor/flag-icon-css/flags/1x1/es.svg"
                        alt="Image description"
                        width="16"
                      />
                      <span>Español</span>
                    ...
                    <a className="dropdown-item d-flex align-items-center" href="#">
                      <img
                        className="avatar avatar-xss avatar-circle me-2"
                        src="dist/assets/vendor/flag-icon-css/flags/1x1/cn.svg"
                        alt="Image description"
                        width="16"
                      />
                      <span>中文 (繁體)</span>
        ...
        <div className="w-md-85 text-lg-center mx-lg-auto">
          ...
          <p className="text-muted small">
            ...
            providers may use cookies for storing information to help provide you with a better, faster,
